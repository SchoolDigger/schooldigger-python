...
class APISchoolFull30(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["testScores", "schoolid", "schoolName", "phone", "url", "urlSchoolDigger", "urlCompareSchoolDigger", "address", "locale", "lowGrade", "highGrade", "schoolLevel", "isCharterSchool", "isMagnetSchool", "isVirtualSchool", "isTitleISchool", "isTitleISchoolwideSchool", "isPrivate", "privateDays", "privateHours", "privateHasLibrary", "privateCoed", "privateOrientation", "ncesPrivateSchoolID", "district", "county", "reviews", "finance", "graduationRates", "dropoutRates", "chronicAbsenteeismRates", "rankHistory", "rankMovement", "schoolYearlyDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testScores": [APITestScoreWrapper30.from_dict(_item) for _item in obj["testScores"]] if obj.get("testScores") is not None else None,
