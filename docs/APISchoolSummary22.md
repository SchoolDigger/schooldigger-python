...
api_school_summary22_instance = APISchoolSummary22.from_json(json)
# print the JSON string representation of the object
print(APISchoolSummary22.to_json())

# convert the object into a dict
api_school_summary22_dict = api_school_summary22_instance.to_dict()
# create an instance of APISchoolSummary22 from a dict
api_school_summary22_from_dict = APISchoolSummary22.from_dict(api_school_summary22_dict)
```
