...
------------ | ------------- | ------------- | -------------
**submit_date** | **str** | The date the review was submitted, formatted as M/D/YYYY (e.g. &#39;1/24/2009&#39;). Note: single-digit months and days are not zero-padded. | [optional] 
**number_of_stars** | **int** | Number of stars - 1 (poor) to 5 (excellent) | [optional] 
**comment** | **str** | Free-text comment left by the reviewer. Content is HTML encoded (special characters escaped). May be empty string if reviewer only left a star rating. | [optional] 
