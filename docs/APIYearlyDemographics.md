...
**percentof_african_american_students** | **float** | Percentage of students who are Black or African American (NCES definition: a person having origins in any of the black racial groups of Africa) | [optional] 
**percentof_asian_students** | **float** | Percentage of students who are Asian (NCES definition: a person having origins in any of the original peoples of the Far East, Southeast Asia, or the Indian subcontinent) | [optional] 
**percentof_hispanic_students** | **float** | Percentage of students who are Hispanic or Latino (NCES definition: a person of Cuban, Mexican, Puerto Rican, South or Central American, or other Spanish culture or origin, regardless of race) | [optional] 
**percentof_indian_students** | **float** | Percentage of students who are American Indian or Alaska Native (NCES definition: a person having origins in any of the original peoples of North and South America who maintains tribal affiliation or community attachment) | [optional] 
**percentof_pacific_islander_students** | **float** | Percentage of students who are Native Hawaiian or Other Pacific Islander (NCES definition: a person having origins in any of the original peoples of Hawaii, Guam, Samoa, or other Pacific Islands) | [optional] 
**percentof_white_students** | **float** | Percentage of students who are White (NCES definition: a person having origins in any of the original peoples of Europe, the Middle East, or North Africa) | [optional] 
**percentof_two_or_more_race_students** | **float** | Percentage of students reporting two or more races (not Hispanic/Latino) | [optional] 
**percentof_unspecified_race_students** | **float** | Percentage of students whose race/ethnicity was not specified or reported | [optional] 
...
**numberof_indian_students** | **int** | Count of American Indian or Alaska Native students (NCES definition: a person having origins in any of the original peoples of North and South America who maintains tribal affiliation or community attachment) | [optional] 
...
**numberof_unspecified_race_students** | **int** | Count of students whose race/ethnicity was not specified or reported | [optional] 
