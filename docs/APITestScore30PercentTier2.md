...
json = "{}"
# create an instance of APITestScore30PercentTier2 from a JSON string
api_test_score30_percent_tier2_instance = APITestScore30PercentTier2.from_json(json)
# print the JSON string representation of the object
print(APITestScore30PercentTier2.to_json())

# convert the object into a dict
api_test_score30_percent_tier2_dict = api_test_score30_percent_tier2_instance.to_dict()
# create an instance of APITestScore30PercentTier2 from a dict
api_test_score30_percent_tier2_from_dict = APITestScore30PercentTier2.from_dict(api_test_score30_percent_tier2_dict)
```
